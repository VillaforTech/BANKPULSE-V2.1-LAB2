...
- Broker: `redpanda:9092`, topic `bankpulse.social-split.events.v1`, clave `aggregateId`, una partición y retención de 24 h para el laboratorio. El bootstrap es idempotente y no recrea topics existentes.
...
Referencia: [gemelo](https://github.com/VillaforTech/BANKPULSE-V2.1-LAB2-REFERENCE). Código de referencia asistido por Codex; cada integrante conserva autoría y evidencia de su implementación.
